...
[[maybe_unused]] uint32_t NNOPBASE_MatmulW4a16Custom = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnMatmulW4a16CustomTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "MatmulW4a16Custom";
    ...
    NNOPBASE_ASSERT_NOTNULL_RETVAL(scales);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, w, 1));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, scales, 2));
    ...
    if (NnopbaseAddParamName != NULL) {
        ...
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 1, "w", true));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 2, "scales", true));
