...
[[maybe_unused]] uint32_t NNOPBASE_MatmulW8a8I32Custom = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnMatmulW8a8I32CustomTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "MatmulW8a8I32Custom";
    char inputDesc[] = {1, 1};
    char outputDesc[] = {1};
    char attrDesc[] = {};
