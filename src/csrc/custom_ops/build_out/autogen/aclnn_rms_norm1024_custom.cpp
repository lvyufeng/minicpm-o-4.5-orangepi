...
[[maybe_unused]] uint32_t NNOPBASE_RmsNorm1024Custom = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnRmsNorm1024CustomTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "RmsNorm1024Custom";
    char inputDesc[] = {1, 1};
    char outputDesc[] = {1};
    char attrDesc[] = {0};
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    float tmp0 = static_cast<float>(epsilon);
    ...
    if (NnopbaseAddParamName != NULL) {
        ...
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 1, "gamma", true));
