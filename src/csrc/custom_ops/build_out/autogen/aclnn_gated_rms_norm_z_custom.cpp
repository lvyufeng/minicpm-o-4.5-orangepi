...
[[maybe_unused]] uint32_t NNOPBASE_GatedRmsNormZCustom = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnGatedRmsNormZCustomTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "GatedRmsNormZCustom";
    char inputDesc[] = {1, 1, 1};
    char outputDesc[] = {1};
    char attrDesc[] = {};

    NNOPBASE_ASSERT_NOTNULL_RETVAL(core);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(zSilu);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, core, 0));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, zSilu, 1));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, gamma, 2));
    ...
    if (NnopbaseAddParamName != NULL) {
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 0, "core", true));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 1, "zSilu", true));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 2, "gamma", true));
